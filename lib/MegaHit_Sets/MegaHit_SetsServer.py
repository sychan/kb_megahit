...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_MegaHit_Sets.run_megahit,
                             ...
                             types=[dict])
        self.method_authentication['MegaHit_Sets.run_megahit'] = 'required'
        self.rpc_service.add(impl_MegaHit_Sets.exec_megahit,
                             name='MegaHit_Sets.exec_megahit',
                             types=[dict])
        self.method_authentication['MegaHit_Sets.exec_megahit'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "MegaHit_Sets but no authentication header was passed"
                            raise err
