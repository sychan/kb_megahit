...
public class MEGAHITClient {
     ...
     * credentials.
     */
    public MEGAHITClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
     ...
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.megahit.MegaHitParams MegaHitParams}
     * @return   parameter "output" of type {@link us.kbase.megahit.MegaHitOutput MegaHitOutput}
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("MEGAHIT.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
